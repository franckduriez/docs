...
- Access as a [billing contact](https://docs.ovh.com/asia/en/customer/managing-contacts/#definition) to your OVHcloud services
...
- [Display the renewal statuses for your services](https://docs.ovh.com/asia/en/billing/how-to-use-automatic-renewal-at-ovh/#display-the-renewal-statuses-for-your-services): This guide will help you check if your services are renewed automatically. You can also retrieve their renewal or expiry dates.

- [Manage renewal for your services](https://docs.ovh.com/asia/en/billing/how-to-use-automatic-renewal-at-ovh/#renewal-at-ovhcloud): This guide will help you enable or disable automatic renewal, change a service’s payment frequency and pay for renewals before their expiry date.

- [Manage your payment methods](https://docs.ovh.com/asia/en/billing/manage-payment-methods/): Using this guide, you can check that you have a saved payment method for future renewals. You can also add and delete payment methods, if required.

### Access your service’s settings

Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia). Click on the name associated with your NIC handle (Customer ID) in the menu bar at the top right-hand corner then choose `Service Management`{.action}.
...
If you have not registered a [payment method](https://docs.ovh.com/asia/en/billing/manage-payment-methods/), an invoice will be sent to you by email. You can then pay it online.
...
If you do not wish to renew one of these services, simply [cancel it via the OVHcloud Control Panel](https://docs.ovh.com/asia/en/billing/how-to-cancel-your-services/).
...
> [!warning]
>
> For more information on cancelling OVHcloud services, follow the instructions in this [guide](https://docs.ovh.com/asia/en/billing/how-to-cancel-your-services/).
>
...
[Information regarding Public Cloud billing options](https://docs.ovh.com/asia/en/public-cloud/information-on-cloud-billing-options/)
